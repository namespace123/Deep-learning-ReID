...
from core.compute_distance import cosine_dist, label2similarity
...
def mining_hard_pairs(feature_vector_list, pids):
    ...
    for feature_vector in feature_vector_list:  # 去除梯度，得到新的list
    ...
    return new_feature_vector_list, p_feature_vector_list, n_feature_vector_list  # 全是14个（8，2048）
