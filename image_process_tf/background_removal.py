...
parser.add_argument('-i', '--input-dir', type=str, default='C:\\dataset\\Occluded_Duke\\query', help="input_dir")
parser.add_argument('-o', '--output-dir', type=str, default='C:\\dataset\\Occluded_Duke\\query_ex', help="output_dir")
# parser.add_argument('-i', '--input-dir', type=str, default='C:\\data\\Occluded_Duke\\bounding_box_test', help="input_dir")
# parser.add_argument('-o', '--output-dir', type=str, default='C:\\data\\Occluded_Duke\\bounding_box_test_ex2', help="output_dir")
parser.add_argument('-m', '--model', type=str, default='xception_model', help="xception_model or mobile_net_model")
parser.add_argument('-d', '--dataset', type=str, default='Occluded_Duke', help="Occluded_Duke or MARS")
